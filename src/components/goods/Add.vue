...
<!--            步骤条区域-->
            <el-steps :space="200" :active="activeIndex - 0" finish-status="sucsess" align-center>
        ...
        methods:{
           ...
           async getCateList(){
            ...
            beforeTabLeave(activateName, oldActivateName){
               // console.log('即将离开的标签页的名字是：' + oldActivateName)
               // console.log('即将进入的标签页的名字是：' + activateName)
                if (oldActivateName === '0' && this.addForm.goods_cat.length !== 3){
            ...
            //添加商品
             add(){
               this.$refs.addFormRef.validate( async valid => {
                   ...
                   //添加业务逻辑
                   //深拷贝addForm.goods_cat ,由于绑定时需要的是数组强行转化成字符串会报错\
