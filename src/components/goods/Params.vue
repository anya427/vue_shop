...
<!--                        索引列-->
                        ...
                        <el-table-column label="操作">
                            <template v-slot="scope">
                                <el-button type="primary" icon="el-icon-edit" size="mini" @click="editCate(scope.row.attr_id)">编辑</el-button>
...
<!--        添加参数的对话框-->
        <el-dialog
            ...
            <el-form :model="addForm" :rules="addFormrules" ref="addFormRef" label-width="100px" @close="">
